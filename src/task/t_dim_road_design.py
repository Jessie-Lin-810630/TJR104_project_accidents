...
def t_dim_road_design(csvfile_paths: list[str]) -> pd.DataFrame:
    ...
    for file_path in csvfile_paths:
        ...
        # 重新命名欄位
        renamed_required_columns = [dim_road_design_col_map[k] for k in required_columns]
        ...
        # 去重
        single_df = df.drop_duplicates(subset=["road_type_primary_party",
                                               "road_form_major",
                                               "road_form_minor"])
...
if __name__ == "__main__":
    ...
    df_road_design = t_dim_road_design(csvfile_paths=["/Users/little_po/Desktop/Project/04_Traffic_accidents/taiwan_traffic_accidents/test/processed_data/114年度A1交通事故資料.csv",
                                                      "/Users/little_po/Desktop/Project/04_Traffic_accidents/taiwan_traffic_accidents/test/processed_data/114年度A2交通事故資料_5.csv"])
